...
M.builtin = {
    html = require('fk_markdown.handler.html'),
    latex = require('fk_markdown.handler.latex'),
    markdown = require('fk_markdown.handler.markdown'),
    markdown_inline = require('fk_markdown.handler.markdown_inline'),
    yaml = require('fk_markdown.handler.yaml'),
}
