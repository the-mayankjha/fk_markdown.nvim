...
function Context.new(buf, win, config, view)
    ...
    self.view = view
    self.conceal =
        require('fk_markdown.request.conceal').new(buf, win, view)
    self.callout = require('fk_markdown.request.callout').new()
    self.checkbox = require('fk_markdown.request.checkbox').new()
    self.inline = require('fk_markdown.request.inline').new()
    self.latex = require('fk_markdown.request.latex').new()
    self.used = require('fk_markdown.request.used').new()
    return self
end
...
function M.new(buf, win, config)
    local view = require('fk_markdown.request.view').new(buf)
